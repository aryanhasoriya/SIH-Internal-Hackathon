    ...
    <section id="hero" className="relative pt-8 pb-16 md:pt-14 md:pb-24 overflow-hidden bg-[#FCFCFD]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Left Column: SIH Identity Visual Composition */}
          <div className="lg:col-span-5 order-2 lg:order-1 flex justify-center">
            <div className="relative w-full max-w-md">
              {/* Outer Card / Framing */}
              <div className="relative p-6 sm:p-8 bg-white border border-slate-200/90 rounded-2xl shadow-xl shadow-slate-200/50 flex flex-col items-center text-center overflow-hidden">
                ...
                <div className="w-full flex items-center justify-between border-b border-slate-100 pb-3 mb-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-bold tracking-wider uppercase text-slate-600">
                      OFFICIAL SELECTION ROUND
                    </span>
                  </div>
                  <span className="text-[11px] font-bold text-[#EA580C] bg-orange-50 px-2 py-0.5 rounded border border-orange-200">
                    2026 EDITION
                  </span>
                </div>

                {/* Primary SIH Graphic (Preserving original aspect ratio) */}
                <div className="relative w-48 sm:w-56 my-2 transform hover:scale-105 transition-transform duration-300">
                  <img
                    src="/assets/sih-logo.png"
                    alt="Smart India Hackathon 2026 Official Identity"
                    className="w-full h-auto object-contain drop-shadow-md mx-auto"
                  />
                </div>

                {/* College SIH Cell Identifier */}
                <div className="mt-6 pt-4 border-t border-slate-100 w-full flex items-center justify-between text-left">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-500">
                        SPOC: {EVENT_INFO.spocName}
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="inline-block text-[10px] font-bold px-2 py-1 bg-slate-900 text-white rounded">
                      TOP 50
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-4 w-full grid grid-cols-2 gap-2 text-center text-xs">
                  <div className="p-2 bg-slate-50 rounded-lg border border-slate-100">
                    <span className="block text-[10px] text-slate-500 uppercase font-semibold">Evaluation</span>
                    <span className="font-bold text-slate-800">External Judges</span>
                  </div>
                  <div className="p-2 bg-orange-50/60 rounded-lg border border-orange-100">
                    <span className="block text-[10px] text-orange-600 uppercase font-semibold">Prototype</span>
                    <span className="font-bold text-orange-950">Working Demo</span>
                  </div>
                </div>
